 ...
 *
 * FIXME: It has not been tested since the migration to a separate
 * (org.civicrm.smartdebit) extension
 */
abstract class CRM_Smartdebit_Utils_Hook {
  ...
  static function alterSmartdebitContributionParams(&$params) {
    return self::singleton()
      ->invoke(1, $params, self::$_nullObject, self::$_nullObject, self::$_nullObject, self::$_nullObject, self::$_nullObject, 'civicrm_alterSmartdebitContributionParams');
  }
  ...
  static function handleAuddisRejectedContribution($contributionId) {
    return self::singleton()
      ->invoke(1, $contributionId, self::$_nullObject, self::$_nullObject, self::$_nullObject, self::$_nullObject, self::$_nullObject, 'civicrm_handleAuddisRejectedContribution');
  }
